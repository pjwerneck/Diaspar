...
# Check if the caller is legit... can be improved
...
# Private storage for attributes
...
class EnablePrivate(type):
    ...
    def __call__(cls, *args, **kwds):
        ...
        new.__privdict__ = PrivateDict(new) #FIXME: weakref needed here
...
def testit():
    ...
    try:
        ...
        assert object.__getattribute__(o.__privdict__, 'data')['foo'] == 'I am foo in o'
        assert object.__getattribute__(a.__privdict__, 'data')['foo'] == 'I am foo in a'
        print 'ERROR'
        # the foo descriptor is a class attribute, so should not
        # be accessible here
    except PrivateAttributeError, msg:
